-- 1. Usuario
INSERT INTO usuario (usuario_id, nombre, email, contrasena, rol, fechaCreacion, activo) VALUES
...
-- 2. Reporte
INSERT INTO reporte (reporte_id, tipo, fechaGeneracion) VALUES
('1', 'tipo 1' ,'12-02-2023'),
('2', 'tipo 2' ,'03-04-2025'),
('3', 'tipo 1' ,'01-04-2024'),
('4', 'tipo 1' ,'20-05-2025');
...
-- 5. Transaccion
INSERT INTO transaccion (transaccion_id, fecha, total, estado, metodoPago) VALUES
...
-- 6. Pedido
INSERT INTO pedido (pedido_id, fecha, estado, direccionEnvio) VALUES
